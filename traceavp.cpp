      ...
      TraceCPU(window, name, recfile, parent)
{
    ...
    addDevice( new GizmoDev(this, "ahb gizmo", TEGRA_AHB_GIZMO_BASE) );
    addDevice( new FuseDev(this, "apb fuse", TEGRA_FUSE_BASE) );
    addDevice( new Apb_dmaDev(this, "apb dma", TEGRA_APB_DMA_BASE) );
    addDevice( new Apb_miscDev(this, "apb misc", TEGRA_APB_MISC_BASE) );
    ...
    addDevice( new Timer_usDev(this, "timer us", TEGRA_TMRUS_BASE) );
...
//    addDevice( new Host1x_channelDev(this, "host1x ch prot", TEGRA_HOST1X_BASE + 0x20000) );
    addDevice( new Res_semaDev(this, "res sema", TEGRA_RES_SEMA_BASE) );
    addDevice( new Arb_semaDev(this, "arb sema", TEGRA_ARB_SEMA_BASE) );
    addDevice( new Arb_gnt_ictlrDev(this, "arb gnt icrtrl", TEGRA_ARBGNT_ICTLR_BASE) );
    ...
    addDevice( new AVP_CchDev(this, "AVP MMU", 0xF0000000) );

    addDevice( new Host1x_channelDev(this, "host1x ch0", TEGRA_HOST1X_BASE) );
    addDevice( new Host1x_syncDev(this, "host1x sync0", TEGRA_HOST1X_BASE + 0x3000) );
    addDevice( new Host1x_channelDev(this, "host1x ch1", TEGRA_HOST1X_BASE + 0x4000) );
    addDevice( new Host1x_syncDev(this, "host1x sync1", TEGRA_HOST1X_BASE + 0x7000) );
    addDevice( new Host1x_channelDev(this, "host1x ch2", TEGRA_HOST1X_BASE + 0x8000) );
    addDevice( new Host1x_syncDev(this, "host1x sync2", TEGRA_HOST1X_BASE + 0xB000) );
    addDevice( new Host1x_channelDev(this, "host1x ch3", TEGRA_HOST1X_BASE + 0xC000) );
    addDevice( new Host1x_syncDev(this, "host1x sync3", TEGRA_HOST1X_BASE + 0x9000) );
    addDevice( new Host1x_channelDev(this, "host1x ch4", TEGRA_HOST1X_BASE + 0x10000) );
    addDevice( new Host1x_syncDev(this, "host1x sync4", TEGRA_HOST1X_BASE + 0x13000) );
    addDevice( new Host1x_channelDev(this, "host1x ch5", TEGRA_HOST1X_BASE + 0x14000) );
    addDevice( new Host1x_syncDev(this, "host1x sync5", TEGRA_HOST1X_BASE + 0x17000) );
    addDevice( new Host1x_channelDev(this, "host1x ch6", TEGRA_HOST1X_BASE + 0x18000) );
    addDevice( new Host1x_syncDev(this, "host1x sync6", TEGRA_HOST1X_BASE + 0x1B000) );
    addDevice( new Host1x_channelDev(this, "host1x ch7", TEGRA_HOST1X_BASE + 0x1C000) );
    addDevice( new Host1x_syncDev(this, "host1x sync7", TEGRA_HOST1X_BASE + 0x1F000) );
    addDevice( new DcDev(this, "host1x dc1", TEGRA_DISPLAY_BASE) );

    addDevice( new Host1xDev(this, "host1x", 0x1) );
    addDevice( new Gr2dDev(this, "host1x gr2d", 0x51) );
    addDevice( new Gr2dDev(this, "host1x gr2d_sb", 0x52) );
    addDevice( new Gr2dDev(this, "host1x gr3d", 0x60) );
